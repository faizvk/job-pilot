    ...
    <div className="space-y-5 animate-fade-in">
      ...
      <div className="bg-white border border-slate-200/60 rounded-2xl shadow-card p-4 sm:p-5 space-y-4">
        ...
        <textarea
          ...
          rows={8}
          className="w-full border border-slate-200 rounded-xl px-3 sm:px-4 py-3 text-sm text-slate-800 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-400 resize-y"
        />
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-emerald-600 to-emerald-500 text-white px-5 py-2.5 rounded-xl text-sm font-medium hover:from-emerald-500 hover:to-emerald-600 disabled:opacity-50 disabled:cursor-not-allowed shadow-sm shadow-emerald-600/20 transition-all active:scale-[0.97] self-start sm:self-auto"
          >
      ...
      {result && (
        <div className="space-y-4 stagger-children">
            ...
            {result.skillMatch.missing.length > 0 && (
              <div className="space-y-2.5">
                <div className="flex items-center justify-between">
                  ...
                  <button onClick={selectAllMissing} className="text-xs text-emerald-600 hover:text-emerald-700 font-medium">
                ...
                {selectedSkills.size > 0 && (
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 bg-emerald-600 text-white px-4 py-2 rounded-xl text-xs font-medium hover:bg-emerald-700 disabled:opacity-50 shadow-sm shadow-emerald-600/20 transition-all active:scale-[0.97]"
                  >
          ...
          {result.resumeSuggestions ? (
            <div className="bg-white border border-slate-200/60 rounded-2xl shadow-card p-4 sm:p-5 space-y-3">
              <div className="flex items-center justify-between">
                    ...
                    return (
                      <button
                        ...
                        className={`w-full text-left flex items-start gap-3 rounded-xl p-3 transition-all ${
                          isSelected ? "bg-emerald-50 ring-2 ring-emerald-400/50" : "bg-slate-50 hover:bg-slate-100"
                        }`}
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <span className="text-xs font-semibold text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded-lg">{suggestion.category}</span>
            ...
            <div className="bg-white border border-slate-200/60 rounded-2xl shadow-card p-4 sm:p-5 space-y-4">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  {savedResumeId && (
                    <a href={`/resumes/${savedResumeId}`} className="inline-flex items-center gap-1.5 bg-emerald-600 text-white px-4 py-1.5 rounded-xl text-xs font-medium hover:bg-emerald-700 transition-all active:scale-[0.97]">
                      Edit in Resumes
                    </a>
                  )}
                </div>
          ...
          <div className="bg-white border border-slate-200/60 rounded-2xl shadow-card p-4 sm:p-5 space-y-4">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-3">
              ...
              <button
                ...
                className="sm:ml-auto inline-flex items-center justify-center gap-2 bg-gradient-to-r from-emerald-600 to-emerald-500 text-white px-5 py-2.5 rounded-xl text-sm font-medium hover:from-emerald-500 hover:to-emerald-600 disabled:opacity-50 shadow-sm shadow-emerald-600/20 transition-all active:scale-[0.97]"
              >
              ...
              <>
                ...
                <div className="flex items-center gap-3">
                  <input
                    ...
                    className="flex-1 border border-slate-200 rounded-xl px-3.5 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-400"
                  />
                  <button
  ...
  return (
    <div className="resume-preview">
      {content.split("\n").map((line, i) => {
        ...
        if (line.startsWith("## "))
          return <h2 key={i} className="text-sm font-semibold mt-4 mb-1.5 text-emerald-700 border-b border-slate-200 pb-1 uppercase tracking-wide">{line.slice(3)}</h2>;
        if (line.startsWith("### "))
