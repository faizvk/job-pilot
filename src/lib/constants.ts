...
export const STATUS_CONFIG: Record<ApplicationStatus, { label: string; color: string; bgColor: string }> = {
  ...
  applied: { label: "Applied", color: "text-emerald-700", bgColor: "bg-emerald-50 ring-1 ring-inset ring-emerald-600/10" },
  phone_screen: { label: "Phone Screen", color: "text-teal-700", bgColor: "bg-teal-50 ring-1 ring-inset ring-teal-600/10" },
