  ...
  return (
    <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-xs">
      ...
      <textarea
        ...
        rows={10}
        className="w-full border border-slate-200 rounded-lg p-3 text-sm resize-none shadow-xs focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-400 transition-all"
